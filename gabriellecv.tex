...
%
\section{Education}
    \cventry{2022 - }{Doctoral Student}{Boston University}{}{\textit{}}{}
...
\section{Research Experience}
    \cventry{01/22 - 08/22}{Graduate Student}{Meyer Lab,}{ Boston University}{}{Researching the neural correlates of conflict decision making during adolescence and adulthood. Detailed Responsibilities:%}
    \begin{itemize}
        \item Process brain tissue for ex-vivo analysis through transcardial perfusion, brain extraction, immunohistochemical staining, and imaging.
        \item Run behavioral paradigms and optogenetic experiments assessing safety learning using a discriminative conditioning paradigm \& other stress paradigms.
        \item Supervise and mentor undergraduates on laboratory research techniques.
    \end{itemize}}
    \cventry{01/22 - 08/22}{Research Technician}{Meyer Lab,}{ Boston University}{}{Researching the neural correlates of safety learning \& inhibitory behavior during adolescence and adulthood. Detailed Responsibilities:%}
    \begin{itemize}
        ...
        \item Run behavioral paradigms assessing safety learning using a discriminative conditioning paradigm.
        \item Supervise and mentor undergraduates on laboratory research techniques. 
    \end{itemize}}
...
%\section{Publications}
 %   \cventry{[1]}{\textnormal{Felix-Ortiz, A. C. Terrel, J. M., Gonzalez, C., Msengi, H. D., Ramos, A. R. , Boggan, M. B., Lopez-Pesina, S. M.,} Magalhães, G.,\textnormal{\& 
  %  Burgos-Robles, A. (2022)}}{"The inframlimbic and prelimbic cortical areas bidirectionally regulate safety learning during normal and stress conditions"}{ In Review}{ 1 October 2022}{}{}
...
\section{Research Skills}
    ...
    \cvdoubleitem{Imaging}{Fiber photometry (novice), 2-Photon Imaging (novice).}{Optogenetics}{Optical ferrule construction, optical plug-in, and acute \& chronic laser light stimulation.}
...
\section{Service}
    \subsection*{Professional}
        \cvitem{07/23}{Mentor for Upward Bound Math Science program at Boston University.}
        \cvitem{06/23}{Research Fellow in the NSF Neurophotonics Research Traineeship (NRT) program at Boston University.}
        \cvitem{05/23 - }{Chair for Diversity, Equity, Inclusion, \& Justice for the Neuroscience Graduate Student Organization at Boston University.}
    ...
    \subsection*{Community}
        ...
        \cvitem{08/18 - 12/18}{Volunteer and Curator for Institute of Texan Cultures to design and curate exhibit on the history of Foster Care.}
\section{References}
